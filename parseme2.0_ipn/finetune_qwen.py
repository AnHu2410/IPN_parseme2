...
class QwenFinetuner:
    def __init__(self, nonthinking, thinking, eval):
    ...
    def combine_data(self, mode="reasoning"):
        data_reasoning = self.prepare_reasoning_training_data()
    ...
    def train_and_save_model(self):
        ...
        self.model.save_pretrained("lora_model_32_ROMANCE")  # Local saving
        self.tokenizer.save_pretrained("lora_model_32_ROMANCE")


def main(nonthinking, thinking, eval):
    q = QwenFinetuner(nonthinking, thinking, eval)
    q.train_and_save_model()


if __name__ == "__main__":
	args = parse_args()
	main(args.nonthinking_data_path, args.thinking_data_path, args.eval)
